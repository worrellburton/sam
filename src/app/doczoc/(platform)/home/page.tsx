...
export default function HomePage() {
  ...
  return (
    <>
                  <main className="dz-platform-main" style={{ padding: 0 }}>
        {/* Top bar */}
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, marginBottom: 32 }}>
            ...
            <div className="dz-card" style={{ padding: "22px 24px" }}>
              ...
              <div style={{ borderTop: "1px solid var(--glass-border)", paddingTop: 12, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <Link href="/doczoc/billing" style={{ display: "flex", alignItems: "center", gap: 4, fontSize: "0.85rem", color: "var(--dz-text-primary)", fontWeight: 600, textDecoration: "none" }}>
                  View
            ...
            <div className="dz-card" style={{ padding: "22px 24px" }}>
              ...
              <div style={{ borderTop: "1px solid var(--glass-border)", paddingTop: 12, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <Link href="/doczoc/rcm" style={{ display: "flex", alignItems: "center", gap: 4, fontSize: "0.85rem", color: "var(--dz-text-primary)", fontWeight: 600, textDecoration: "none" }}>
                  View
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg>
                </Link>
              </div>
