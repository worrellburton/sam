...
const platformLogos: Record<string, string> = {
  Zocdoc: "https://cdn.brandfetch.io/domain/zocdoc.com",
  Google: "https://cdn.brandfetch.io/domain/google.com",
  Healthgrades: "https://cdn.brandfetch.io/domain/healthgrades.com",
  Vitals: "https://cdn.brandfetch.io/domain/vitals.com",
  "U.S. News": "https://cdn.brandfetch.io/domain/usnews.com",
};
            ...
            {platforms.map((p) => (
              <a key={p.name} href={p.url} target="_blank" rel="noopener" className="platform-card">
                <div className="platform-icon" style={{ background: "transparent" }}>
                  <Image src={platformLogos[p.name]} alt={p.name} width={44} height={44} style={{ borderRadius: 10 }} />
                </div>
