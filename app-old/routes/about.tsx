...
const locations = [
  { name: "Upper East Side", address: "159 East 74th St", desc: "Proximity to Lenox Hill • Elite sports & geriatric care" },
  { name: "Greenwich Village", address: "200 West 13th St", desc: "Young professionals & active downtown workforce" },
  { name: "Brooklyn Heights", address: "161 Atlantic Ave", desc: "Families & recreational athletes in Brooklyn" },
  { name: "Scarsdale", address: "2 Overhill Rd", desc: "Suburban Westchester corridor" },
];
          ...
          <div className="abt-split reveal">
            <div className="abt-split-img">
              <picture>
                ...
                <img src="/sam/header.jpg" alt="Dr. Sam Elguizaoui performing surgery" className="abt-portrait" loading="lazy" />
              </picture>
            </div>
            <div className="abt-split-text">
              ...
              <p className="abt-lead-text">
                Dr. Sameh (Sam) Elguizaoui stands at the forefront of a paradigm shift in orthopedics — moving from the historic "reconstructive" model toward <strong>biological restoration and joint salvage</strong>. His practice prioritizes extending the native joint's lifespan through cutting-edge biologics, cartilage repair, and minimally invasive techniques.
              </p>
              <p>
                His target demographic is the <strong>"young active patient"</strong> — a group that presents some of the most difficult challenges due to high functional demands and longer life expectancy. Where a standard surgeon might recommend waiting for a replacement, Dr. Elguizaoui sees an opportunity for biologic salvage.
              </p>
        ...
        <div className="container">
          ...
          <div className="abt-expertise-grid">
            ...
            <div className="abt-expertise-card reveal">
              <div className="abt-expertise-header">
                <div className="abt-expertise-icon">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="5" r="3"/><path d="M12 22V8M5 12H2a10 10 0 0 0 20 0h-3"/></svg>
                </div>
            ...
            <div className="abt-expertise-card abt-expertise-full reveal">
              ...
              <p className="abt-bio-desc">A bridge between conservative management and invasive surgery — using the body's own biology to heal.</p>
        ...
        <div className="container">
          <div className="abt-personal reveal">
            ...
            <div className="abt-personal-text">
              ...
              <p>
                A family man married with four children, Dr. Elguizaoui embodies the "physician-athlete" archetype. His personal interests — <strong>weightlifting and biking</strong> — allow him to empathize experientially with the frustrations of his active patient base. When a patient describes the mechanical pain of a squat or the endurance limits of a cyclist, he doesn't merely analyze the anatomy theoretically — he understands the biomechanics firsthand.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="abt-reputation-grid reveal-stagger">
            <div className="abt-rep-card">
              ...
              <div className="abt-rep-source">Zocdoc · 1,400+ reviews</div>
          ...
          <div className="abt-affiliations reveal-stagger">
            <div className="abt-affil-card">
              <div className="abt-affil-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 21h18M3 7v14M21 7v14M6 21V10M10 21V10M14 21V10M18 21V10M12 7V3l-9 4h18l-9-4z"/></svg>
              </div>
              <h3>Lenox Hill Hospital</h3>
              <p>Primary surgical home · Northwell Health · Home of NISMAT</p>
            </div>
            <div className="abt-affil-card">
              <div className="abt-affil-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 21h18M3 7v14M21 7v14M6 21V10M10 21V10M14 21V10M18 21V10M12 7V3l-9 4h18l-9-4z"/></svg>
              ...
              <p>Associate Physician · One of the largest teaching hospitals in the US</p>
            </div>
            <div className="abt-affil-card">
              <div className="abt-affil-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 21h18M3 7v14M21 7v14M6 21V10M10 21V10M14 21V10M18 21V10M12 7V3l-9 4h18l-9-4z"/></svg>
