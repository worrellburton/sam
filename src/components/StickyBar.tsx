...
export function StickyBar() {
  ...
  return (
    <div className={`sticky-bottom-bar${visible ? " visible" : ""}`} role="complementary" aria-label="Quick info bar">
      ...
      >
        <span className="sticky-bar-btn-icon" aria-hidden="true">
        ...
        <span className="sticky-bar-btn-label">
          <span className="sticky-bar-btn-title">Book Now</span>
          <span className="sticky-bar-btn-sub">Consultation · NYC</span>
        </span>
        <span className="sticky-bar-btn-arrow" aria-hidden="true">
