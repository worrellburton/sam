    ...
    <div>
      ...
      <div className="dz-card" style={{ padding: "22px 26px", marginBottom: 20, borderLeft: `3px solid ${statusColor}` }}>
        ...
        <div style={{ display: "flex", gap: 16 }}>
          <Link href={`/doczoc/patients/${s.patient.id}`} style={{
    ...
    switch (key) {
      ...
      case "patient": return (
        <td key={key} className="dz-col-patient" {...h} style={{ ...cs, transition: "opacity 0.2s ease" }}>
          <Link href={`/doczoc/patients/${s.patient.id}`} onClick={e => e.stopPropagation()} style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--dz-text-primary, #f1f5f9)", textDecoration: "none", fontSize: "0.82rem", overflow: "hidden" }}>
