                      ...
                      {filtered.map((a, i) => {
                        ...
                        return (
                          <tr key={`${a.patient.id}-${a.date}-${i}`} style={{ opacity: a.isPast ? 0.7 : 1 }}>
                            <td>
                              <Link href={`/doczoc/patients/${a.patient.id}`} style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--dz-text-primary, #f1f5f9)", textDecoration: "none", fontSize: "0.82rem" }}>
                ...
                {filtered.map((a, i) => {
                  ...
                  return (
                    <div key={`${a.patient.id}-${a.date}-${i}`} className="dz-card" style={{
                      ...
                      <Link href={`/doczoc/patients/${a.patient.id}`} style={{
                        display: "flex", alignItems: "center", gap: 6,
                      ...
                      return (
                        <tr key={`${a.patient.id}-${a.date}-${i}`} style={{ ...getRowStyle(`${a.patient.id}-${i}`), opacity: a.isPast ? 0.7 : 1 }} onMouseEnter={() => onCellEnter(`${a.patient.id}-${i}`, 0)} onMouseLeave={onCellLeave}>
                          <td className="dz-col-patient">
                            <Link href={`/doczoc/patients/${a.patient.id}`} style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--dz-text-primary, #f1f5f9)", textDecoration: "none", fontSize: "0.82rem", overflow: "hidden" }}>
