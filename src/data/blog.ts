...
`,
  },
  {
    ...
    image: "/images/blog/hockey-orthopedic-injuries.jpg?v=1776203066555",
    imagePrompts: [
      "Photorealistic cinematic editorial photograph of a male hockey player in his late 20s, standing alone on a dimly lit outdoor ice rink in lower Manhattan at blue hour, the city skyline glowing deep blue and burnt orange behind him. He is in full hockey gear minus the helmet, one glove off, his bare hand pressing into the crease of his hip in a classic C-sign grip — cupping the side of his hip as if nursing a deep ache. Steam rises from the ice surface. Shallow depth of field isolates him against the blurred city lights. The composition is wide 16:9, him off-center left, the East River bridges faintly visible in the haze. Muted steel-blue tones with warm amber accents from distant buildings. Nike campaign quality, cinematic natural light, high contrast shadows on ice.",
      "Photorealistic premium editorial photograph inside a high-end Manhattan sports medicine clinic that looks like a performance lab — clean concrete walls, floor-to-ceiling windows showing Midtown towers in soft morning light. A male orthopedic surgeon in his 40s wearing a fitted black quarter-zip and dark trousers examines the hip of a muscular male patient in his early 30s lying on a sleek examination table, rotating the patient's leg into deep flexion and internal rotation to test for femoroacetabular impingement. An MRI scan of a hip with a visible labral tear glows on a large wall-mounted monitor behind them. The color palette is muted charcoal, warm white, and deep blue from the screen. Shallow depth of field, the MRI slightly soft in the background. Composition places the clinical interaction in the left two-thirds, the glowing scan on the right. Cinematic side light cutting through the windows casting long crisp shadows across the floor. 16:9 landscape.",
      "Photorealistic athletic editorial photograph of a fit woman in her late 20s on a rooftop fitness area in Brooklyn at golden hour, the Manhattan skyline soft and warm in the background. She is performing a single-leg glute bridge on a black mat, one knee drawn up, her expression focused and determined. Beside her on the ground is a foam roller and a pair of hockey skates with the blades catching the golden light. She wears minimal black athletic wear — quiet luxury compression leggings and a cropped top. The warm amber sunset light rakes across her body from the left, creating high-contrast shadows on the rooftop concrete. Deep blue sky gradients above the skyline. The composition is low angle, wide 16:9, emphasizing the bridge between rehabilitation work and the sport she's returning to. Premium Nike-Equinox campaign aesthetic, shallow depth of field on the skates in the foreground.",
      "Photorealistic conceptual editorial photograph shot from directly above — a bird's-eye view of a quarter-inch steel hockey skate blade resting on a smooth dark surface, and next to it, an anatomical model of a human hip joint showing the femoral head seated in the acetabulum with a subtle labral tear visible. The two objects are lit by a single dramatic shaft of warm golden light cutting diagonally across the frame as if sunlight is slicing between NYC buildings through a loft window. The rest of the frame falls into deep shadow. The blade reflects a sliver of burnt orange light. The color DNA is matte black, steel grey, warm amber highlight, and a hint of deep blue in the shadows. Shallow depth of field with the labrum detail and blade edge both critically sharp. Minimalist, abstract, editorial — the visual tension between the tool of the sport and the anatomy it slowly destroys. 16:9 landscape, cinematic still-life quality."
    ],
