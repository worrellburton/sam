...
const DOCTORS = [
  {
    id: 1, name: "Dr. Sameh Elguizaoui", title: "Orthopedic Surgeon & Sports Medicine", rating: 4.78, reviews: 1400, image: "/header.webp",
    ...
    website: "https://worrellburton.github.io/",
  },
  {
    ...
    <div className={`v2-page${loaded ? " v2-loaded" : ""}`}>
      ...
      <nav className="v2-nav v2-anim-fade">
        <div className="v2-nav-inner">
          <Link href="/doczoc" className="v2-logo">
            <div className="v2-logo-icon">D</div>
            <span>DocZoc</span>
          </Link>
          <div className="v2-nav-right">
            <Link href="/doczoc/signin" className="v2-nav-link">Sign In</Link>
            <Link href="/doczoc/signin" className="v2-nav-cta">Get Started</Link>
          </div>
        </div>
      </nav>
