...
export const blogPosts: BlogPost[] = [
  {
    ...
    image: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/radial-head-fracture-elbow.webp?v=1776290761244",
    imagePrompts: [
      "Photorealistic cinematic editorial photograph, 16:9 landscape. A woman in her early 30s in a minimalist black athletic tank top stands on a Tribeca cobblestone street at golden hour, her left arm held slightly bent at her side, unable to fully straighten. She stares down at her own elbow with a tense, searching expression. Late afternoon sun cuts between cast-iron loft buildings, throwing long dramatic shadows across the street. Shallow depth of field isolates her figure against blurred SoHo architecture. Muted warm tones with deep charcoal shadows and one accent of burnt orange from a reflected awning. Her skin shows a subtle bruise blooming across the lateral elbow. The mood is frustration and uncertainty — an injury that looks like nothing but feels like everything. Premium Nike-campaign quality, no text.",
      "Photorealistic premium editorial photograph, 16:9 landscape. Inside a high-end private orthopedic practice in Manhattan — clean white walls, warm oak millwork, floor-to-ceiling windows showing a hazy East River skyline. A male sports medicine physician in his late 30s wearing a fitted navy quarter-zip and no white coat carefully palpates the lateral elbow of a seated male patient in his late 20s wearing a dark grey athletic compression shirt. The physician's fingers press precisely three centimeters below the lateral epicondyle while gently rotating the patient's forearm in pronation. On a slim mounted monitor behind them, a lateral elbow x-ray glows showing a subtle posterior fat-pad sign — a crescent of displaced fat. Cinematic natural window light rakes across the scene with crisp shadows. Color palette: warm whites, deep navy, muted grey, and a single burnt-orange accent from a small design element in the room. Shallow depth of field, shot at eye level. No text.",
      "Photorealistic cinematic editorial photograph, 16:9 landscape. Early morning on a rooftop fitness deck overlooking the Manhattan skyline from Brooklyn. A fit woman in her late 20s in black leggings and a muted burnt-orange sports bra performs slow, deliberate forearm pronation and supination exercises with a light resistance band looped around her hand, her elbow bent at roughly 90 degrees. Her expression is focused and calm — controlled rehabilitation in motion. A small sling sits folded on a bench beside her, no longer needed. Soft golden-hour light catches the East River and distant skyscrapers behind her. Shallow depth of field, the skyline rendered in creamy bokeh. Muted color palette: slate grey concrete, warm skin tones, black athletic wear, burnt orange accent, pale gold sky. The mood is determined recovery and earned progress. Nike-campaign quality, no text.",
      "Photorealistic conceptual editorial photograph, 16:9 landscape. Extreme close-up macro shot of a human elbow joint area from a lateral angle — the skin of an athletic arm in its 30s, subtly defined triceps and forearm musculature visible. The arm is caught mid-motion transitioning from bent to nearly straight, frozen at the exact point where extension stops short. Dramatic side-lighting from a west-facing Manhattan loft window casts a razor-sharp shadow line diagonally across the forearm, visually bisecting the joint — a metaphor for the hidden fracture line that imaging misses. The background is a blurred sliver of distant city buildings through glass, rendered in deep blue-grey tones. Shallow depth of field so only the elbow crease and lateral bump of the radial head are in tack-sharp focus. Color DNA: deep navy shadow, warm amber highlight, muted skin tones, charcoal background. The mood is forensic and investigative — the body concealing its own injury. No text."
    ],
    image1x1: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/radial-head-fracture-elbow-1x1.webp?v=1776290761244",
    image3x4: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/radial-head-fracture-elbow-3x4.webp?v=1776290761244",
    imageAlt: "Woman on a Tribeca cobblestone street at golden hour holding her bent elbow with visible bruising — radial head fracture in Manhattan",
    content: "",
    contentHtml: `
<div class="blog-toc">
...
`,
  },
  {
    ...
    image: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/total-knee-replacement-2026.webp?v=1776290764938",
    imagePrompts: [
      "A woman in her late 30s stands at the top of a brownstone stoop in Brooklyn at golden hour, one foot on the step above the other, sunlight cutting between buildings and casting long cinematic shadows across weathered stone. She wears black compression leggings and a muted burnt-orange running top, her hand resting on the iron railing as she looks down the staircase with a composed expression that blends determination and vulnerability — stairs she once avoided now reclaimed. Shallow depth of field blurs the row of brownstones behind her into warm amber bokeh. The light is warm, directional, high-contrast. Her left knee catches the golden sidelight, the focal point of the composition. Shot from a low angle looking slightly upward, emphasizing the geometry of the steps. Photorealistic premium editorial photography, 16:9 landscape, Nike campaign aesthetic, muted palette with burnt-orange accent.",
      "Interior of an ultra-modern private surgical suite bathed in cool blue-white light with warm accent from a single overhead surgical lamp. A surgeon in sleek black scrub top and loupes works alongside a robotic guidance arm positioned over a draped knee, the arm's haptic saw held precisely against bone. A large monitor in the background displays a glowing 3D CT reconstruction of a knee joint with color-coded implant positioning overlays in deep blue and white. Small optical tracking pins are visible on the exposed bone, catching the light. The environment is minimal, dark-walled, and resembles a performance lab more than a hospital — polished concrete floor, no fluorescent tubes. Shallow depth of field focuses on the surgeon's gloved hands and the robotic arm's contact point. Cinematic, photorealistic, 16:9 landscape, muted steel and deep-blue palette with one warm surgical-lamp accent.",
      "Early morning in Central Park, soft diffused light filtering through spring canopy. A man in his mid-40s wearing quiet-luxury athletic wear — dark navy joggers, black technical half-zip — rides a matte-black road bike along the park loop, body relaxed and confident, his left knee in smooth mid-pedal rotation catching a shaft of warm light. Behind him the Manhattan skyline rises above the treeline in soft focus, pale and monumental. His expression is calm and absorbed, someone three months past surgery rediscovering motion. The road is damp from overnight rain, reflecting the trees above. Composition is wide and cinematic, cyclist positioned in the left third with the skyline filling the right. Photorealistic editorial, 16:9 landscape, muted palette of navy, black, and soft green with warm golden light accents, shallow depth of field.",
      "Abstract macro-inspired photorealistic still life on a dark matte surface: a polished titanium knee implant component — femoral shield with its curved condyles and porous cementless coating visible — rests beside a thin cross-section CT scan printout showing a knee's bone architecture, both illuminated by a single directional light source from the upper left that creates crisp geometric shadows. A faint reflection of the Manhattan skyline at dusk glows in the polished metal surface of the implant. The background is pure black fading to deep navy. The composition emphasizes the implant's engineered curves echoing natural bone geometry — precision meeting anatomy. One small burnt-orange alignment marker dot on the CT printout provides the sole color accent. Photorealistic, 16:9 landscape, cinematic product-editorial hybrid, shallow depth of field, muted palette of titanium silver, bone white, deep navy, and burnt orange."
    ],
    image1x1: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/total-knee-replacement-2026-1x1.webp?v=1776290764938",
    image3x4: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/total-knee-replacement-2026-3x4.webp?v=1776290764938",
    imageAlt: "Cyclist pedaling smoothly through Central Park after total knee replacement, Manhattan skyline in soft morning light",
    content: "",
    contentHtml: `
<div class="blog-toc">
  <h4>In This Article</h4>
