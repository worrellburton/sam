// FAQs and stats displayed on each /services/[slug] page. Keyed by the
// service slug. Lives in /data so the page can stay a pure Server
// Component without importing its own giant literal.
...
export const serviceStats: Record<string, ServiceStat[]> = {
  "sports-medicine": [
