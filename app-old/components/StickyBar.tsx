  ...
  return (
    <div className={`sticky-bottom-bar${visible ? " visible" : ""}`}>
      <div className="sticky-bar-info">
        <Link to="/reviews" className="sticky-bar-rating">
          <svg className="sticky-bar-google-icon" width="16" height="16" viewBox="0 0 24 24">
      ...
      <Link to="/book" className="sticky-bar-btn">
        Book Now
      </Link>
    </div>
  );
