...
`,
  },
  {
    ...
    image: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/shoulder-replacement-anatomic-reverse.webp?v=1776291369500",
    imagePrompts: [
      "Cinematic photorealistic editorial photograph, 16:9 landscape. A woman in her mid-30s stands on a Manhattan rooftop at golden hour, arms raised fully overhead in a fluid stretch, silhouetted against the amber-lit skyline with the East River glinting behind her. She wears minimal black athletic wear. One shoulder catches the warm directional light, the deltoid and rotator cuff musculature sculpted in sharp relief — the anatomy itself telling the story of a joint that depends on soft tissue, not bone. Deep blue shadows contrast with burnt orange sun flare. Shallow depth of field blurs the distant skyline into bokeh. The mood is aspirational tension: can this shoulder keep working? Nike campaign-level composition, premium athletic editorial energy, no text.",
      "Photorealistic premium editorial photograph, 16:9 landscape. Inside a sleek, high-end private orthopedic practice in a Chelsea loft-style space with tall industrial windows casting crisp directional afternoon light across a matte-black surgical planning desk. A male surgeon in his early 40s wearing a fitted dark quarter-zip reviews a glowing 3D CT reconstruction of a shoulder joint on a large monitor, two distinct gleaming implant trays open side by side on the desk — one showing an anatomic ball-and-socket, the other a reverse configuration with the ball mounted where the socket should be. The metallic cobalt-chrome components catch the window light. Muted palette of charcoal, steel blue, and warm amber from the window. Shallow depth of field focuses on the surgeon's hands hovering between both trays, capturing the decisive moment of choosing between two opposite philosophies. Cinematic, editorial, no text.",
      "Photorealistic athletic editorial photograph, 16:9 landscape. Early morning on a brownstone-lined Brooklyn street, soft diffused light cutting between buildings. A fit man in his late 30s wearing a deep navy compression top performs guided shoulder rehabilitation — arm elevated in a controlled active-assisted motion, one hand supporting the opposite arm at the elbow as if doing a table-slide exercise standing against a wrought-iron stoop railing. His expression is focused, determined, mid-recovery. Behind him the Williamsburg Bridge is visible in atmospheric haze. Muted earth tones and steel blue dominate, with one bold burnt-orange accent on his sneakers. The composition emphasizes the shoulder's range of motion — the arm reaching progressively upward. Shallow depth of field, cinematic natural light, the feeling of a patient returning to motion month by month. No text.",
      "Conceptual photorealistic editorial photograph, 16:9 landscape. Extreme close-up still life on a dark matte surface inside a high-end performance lab with soft NYC window light from the left. Two polished shoulder replacement implants placed side by side — one anatomic configuration with the chrome ball on top and polyethylene socket below, the other reversed with the metal glenosphere fixed to a baseplate and the cup sitting above — mirror images of each other, their reflective surfaces catching identical shafts of amber light from opposite angles. Between them, barely visible in shallow depth of field, a translucent anatomical model of a rotator cuff tendon envelope draped like delicate fabric, symbolizing the soft tissue that decides everything. Deep shadows, burnt orange light accent, steel blue reflections. The composition feels like a luxury product campaign — two premium objects, two philosophies, one decisive biological variable. No text."
    ],
    image1x1: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/shoulder-replacement-anatomic-reverse-1x1.webp?v=1776291369500",
    image3x4: "https://wgznytmxwslupjhsdeha.supabase.co/storage/v1/object/public/blog-thumbnails/shoulder-replacement-anatomic-reverse-3x4.webp?v=1776291369500",
    imageAlt: "Woman stretching arms overhead on a Manhattan rooftop at golden hour — anatomic vs reverse shoulder replacement decision",
    content: "",
    contentHtml: `
<div class="blog-toc">
  <h4>In This Article</h4>
