      ...
      <main className={`dz-platform-main${collapsed ? " dz-main-expanded" : ""}`}>
        ...
        {view === "grid" ? (
          <div className="dz-team-grid">
            {filtered.map(m => (
              <Link to={`/doczoc/team/${m.id}`} key={m.id} className="dz-team-card" style={{ textDecoration: "none", color: "inherit" }}>
            ...
            <table className="dz-table">
              ...
              <tbody>
                {filtered.map(m => (
                  <tr key={m.id}>
                    <td>
                      <Link to={`/doczoc/team/${m.id}`} style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "inherit" }}>
