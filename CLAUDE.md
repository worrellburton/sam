...
- `/book` remains a client component — migration deferred due to its interactivity.
...
2. **Oversized files** — `src/app/dev/blog/page.tsx` (2,385 lines), `src/app/book/page.tsx` (1,302), `src/data/blog.ts` (2,326). Candidates for extraction.
3. **Lighthouse CI + bundle-size budget** — add to `.github/workflows/ci.yml` against a Vercel preview URL.
